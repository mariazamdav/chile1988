...
![](picture.png){width=90% fig-align="center"}
...
- CR2 standard errors at the province level

Controls: Logged distance to regional capital, share of left-wing votes in the latest democratic election (1970), population, share of victims across time relative to 1970 population, share of rural population (only in first specification)
...
## Mean years of schooling and vote share "No"  

::: {style="text-align: center;"}
![](education_pattern.png){width=70%}
:::


## Sensitivity test: Rank-based effects

Rank proportion per municipality


::: {style="display: flex; align-items: center; height: 40%;"}
...
::: {.aside}
RV (sig.) interpretation: "A confounder associated with both treatment and outcome explaining more than X% of residual variance in each would turn the estimate insignificant."\
